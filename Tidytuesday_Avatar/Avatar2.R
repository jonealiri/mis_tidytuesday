...
#Ahora voy a hacer un gráfico de barras para cada libro.
#Las barras mostrarán la proporción de palabras de cada
...
#No consigo ordenar las barras en cada faceta, así que voy
#a hacer un gráfico por libro.
...
# Usando patchwork juntaré los gráficos
